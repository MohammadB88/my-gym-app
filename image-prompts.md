...
| Core A — Stability | [`image-prompts/core-a.md`](image-prompts/core-a.md) | CA-00 … CA-06 |
| Core B — Oblique Emphasis | [`image-prompts/core-b.md`](image-prompts/core-b.md) | CB-00 … CB-06 |
...
Core A and Core B share five exercises (Cat-Camel, Dead Bug, Side Plank, Bird Dog,
Prone Back Extension) — their prompts are near-duplicates, so it's fine to reuse
one session's generated image for the other instead of regenerating.
